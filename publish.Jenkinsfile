        ...
        stage('Generate Vulnerability report V2.0') {
            ...
            steps {
                script {
                    ...
                    if (env.VA_REPORT_UPLOAD_ENABLED == "true") {
            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'eridoc-user', usernameVariable: 'ERIDOC_USERNAME', passwordVariable: 'ERIDOC_PASSWORD')]) {
                        ...
                        sh "${bob} eridoc-upload:eridoc-upload"
                        sh "${bob} eridoc-upload:eridoc-approve"
                    }
    ...
    post {
        success {
            ...
            script {
                ...
                ci_pipeline_post.commonPostSteps("publish")
