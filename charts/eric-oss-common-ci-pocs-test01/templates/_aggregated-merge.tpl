...
*/ -}}
{{- define "eric-oss-common-ci-pocs-test01.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-test01.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-test01.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-test01.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-test01.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
